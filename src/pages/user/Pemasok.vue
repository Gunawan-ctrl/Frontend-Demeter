          ...
          <q-tr :props="props">
            <q-td key="PROFIL" :props="props">
              <q-avatar size="lg" rounded>
                <img
                  :src="
                    props.row.PROFIL === '-' || props.row.PROFIL === null
            ...
            <q-td key="ID_PEMASOK" :props="props">
              <q-badge color="positive">{{ props.row.ID_PEMASOK }}</q-badge>
            </q-td>
    ...
    >
      <q-card class="bg-positive text-white">
        ...
        <q-card-actions align="right">
          <q-btn
            @click="this.deleteData(this.idpemasok)"
            flat
            label="Lanjutkan"
            color="white"
            v-close-popup
  ...
  methods: {
    ...
    onSubmit() {
      if (this.editMode) {
        this.$q.loading.show();
        this.$axios
          .put(`pemasok/${this.idActive}`, this.form)
