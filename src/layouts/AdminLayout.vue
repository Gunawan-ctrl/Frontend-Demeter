<template>
  <q-layout view="lHh Lpr lFf">
    <q-header class="bg-white text-green-13">
      <q-toolbar class="q-pt-sm">
        ...
        <div class="row q-gutter-md">
          ...
          <q-btn
            ...
            size="md"
            icon="account_circle"
            :label="this.dataUser.user.USERNAME"
          >
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above>
      ...
      >
        <q-item>
          ...
          <q-item-section>
            <q-item-label>{{ this.dataUser.user.USERNAME }}</q-item-label>
        ...
        <q-list>
          ...
          >
            ...
            >
              ...
              <q-item-section> Jenis Pengguna </q-item-section>
            </q-item>
            ...
            >
              ...
              <q-item-section> Jenis Laporan </q-item-section>
            </q-item>
          </q-expansion-item>
        </q-list>
      </q-card>
